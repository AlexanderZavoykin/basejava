...
import com.gmail.aazavoykin.storage.SortedArrayStorage;
...
public class MainArray {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Resume r;
        while (true) {
            System.out.print("Введите одну из команд - (list | save full name | update uuid full name| delete uuid | get uuid | clear | exit): ");
